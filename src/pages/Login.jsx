...
function Login() {
  ...
  return (
    <div className=" px-4 py-12 bg-[var(--bg-main-layout)] ">
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl shadow-[0_14px_40px_rgba(2,6,23,.10)]">
          <div className="p-5 border-b border-[var(--border)] mb-4 bg-[var(--bg-main-layout)] rounded-t-2xl">
            <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
              <h2 className="text-3xl font-extrabold text-[var(--primary)]">Login</h2>
              ...
              <div className="inline-flex items-center gap-2 max-w-full rounded-full px-4 py-3 font-semibold border border-[var(--all-badge-border)] bg-[var(--all-badge-bg)]">
                ...
                <span className="truncate text-[var(--primary)]">Welcome back</span>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 px-5 pb-4">
            <div className="grid gap-3 p-4 rounded-2xl border border-[rgba(22,163,74,.14)] bg-[rgba(22,163,74,.06)]">
              <div className="text-base font-extrabold text-[var(--text)]">Credentials</div>
          ...
          <div className="grid gap-3 px-5 pb-6">
              ...
              <span className="relative flex items-center justify-center gap-3">
                <span className="grid place-items-center size-9 rounded-2xl border border-[rgba(2,6,23,.08)] bg-[rgba(2,6,23,.02)]">
                  <svg viewBox="0 0 48 48" className="size-5" aria-hidden="true">
                    <path
                      fill="#FFC107"
                      d="M43.611 20.083H42V20H24v8h11.303C33.644 32.651 29.174 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.957 3.043l5.657-5.657C34.067 6.053 29.268 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"
                    />
                    <path
                      fill="#FF3D00"
                      d="M6.306 14.691l6.571 4.819C14.655 16.108 19.0 12 24 12c3.059 0 5.842 1.154 7.957 3.043l5.657-5.657C34.067 6.053 29.268 4 24 4 16.318 4 9.656 8.337 6.306 14.691z"
                    />
                    <path
                      fill="#4CAF50"
                      d="M24 44c5.066 0 9.784-1.947 13.313-5.122l-6.141-5.196C29.11 35.255 26.715 36 24 36c-5.153 0-9.607-3.318-11.265-7.946l-6.52 5.025C9.533 39.556 16.227 44 24 44z"
                    />
                    <path
                      fill="#1976D2"
                      d="M43.611 20.083H42V20H24v8h11.303a11.95 11.95 0 0 1-4.131 5.682l.003-.002 6.141 5.196C36.879 39.245 44 34 44 24c0-1.341-.138-2.65-.389-3.917z"
                    />
                  </svg>
                </span>
            ...
            <p className="text-center text-sm text-[var(--text-soft)]">
              ...
              <Link className=" hover:underline" to="/register">
                <span className='text-[var(--text)] font-semibold'>Register</span>
              </Link>
            </p>
          </div>
        </div>
